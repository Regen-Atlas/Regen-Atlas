...
const KNOWN_PROTOCOLS = new Set(["hedera-guardian", "silvi", "atlantis", "toucan", "regen-network", "ecocerts"]);
...
export function ProtocolIcon({ protocolId, protocolName, size = 16, className }: ProtocolIconProps) {
