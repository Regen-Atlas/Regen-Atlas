import { CurrencyAmount, QUOTER_ADDRESSES, type Token, type TradeType } from "@uniswap/sdk-core";
import { type Route, SwapQuoter } from "@uniswap/v3-sdk";
...
export async function getQuoteFromQuoter({
  ...
  const quoteAmount = decodeAbiParameters(parseAbiParameters("uint256"), quoteCallReturnData.data)[0];
