 ...
 */
export function resolveOrgGeoSync(org: Org, geojson: GeoJSON.FeatureCollection): ResolvedOrgGeo {
 ...
 */
export function resolveAllOrgsGeo(orgs: Org[], geojson: GeoJSON.FeatureCollection): Map<number, ResolvedOrgGeo> {
