  ...
  return (
    ...
    >
      ...
      <Layer
        ...
        paint={{
          "circle-radius": ["step", ["get", "point_count"], 26, 10, 30, 50, 36, 100, 42],
          "circle-color": "#0E7490",
          "circle-opacity": 0.08,
        }}
      />
      ...
      <Layer
        ...
        filter={["has", "point_count"]}
        paint={{
          "circle-color": ["case", ["boolean", ["feature-state", "hover"], false], "#0E7490", "#164E63"],
          "circle-radius": ["step", ["get", "point_count"], 16, 10, 20, 50, 24, 100, 30],
          "circle-stroke-color": [
            "case",
      ...
      <Layer
        ...
        layout={{
          ...
          "text-size": ["step", ["get", "point_count"], 12, 10, 13, 100, 15],
        }}
        paint={{
          "text-color": "#ffffff",
        }}
