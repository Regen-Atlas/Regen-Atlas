...
// @TODO: use memo
export function useTokensBalances({ tokens, account }: UseTokenBalancesProps): Record<string, TokenBalance> {
  ...
  tokens.forEach((token, index) => {
    ...
    let formattedBalance = formatNumber(result.data.value, result.data.decimals, 3);
