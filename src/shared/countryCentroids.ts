...
export const COUNTRY_CENTROIDS: Record<string, { latitude: number; longitude: number }> = {
  ...
  AD: { latitude: 42.55, longitude: 1.6 },
  ...
  BQ: { latitude: 12.2, longitude: -68.26 },
  ...
  CV: { latitude: 16.0, longitude: -24.01 },
  ...
  FK: { latitude: -51.8, longitude: -59.55 },
  ...
  GL: { latitude: 71.71, longitude: -42.6 },
  ...
  HM: { latitude: -53.08, longitude: 73.5 },
  VA: { latitude: 41.9, longitude: 12.45 },
  HN: { latitude: 15.2, longitude: -86.24 },
  HK: { latitude: 22.4, longitude: 114.11 },
  ...
  MO: { latitude: 22.2, longitude: 113.54 },
  ...
  ML: { latitude: 17.57, longitude: -4.0 },
  ...
  NC: { latitude: -20.9, longitude: 165.62 },
  ...
  PN: { latitude: -24.7, longitude: -127.44 },
  ...
  BL: { latitude: 17.9, longitude: -62.83 },
  ...
  WS: { latitude: -13.76, longitude: -172.1 },
  ...
  TK: { latitude: -8.97, longitude: -172.0 },
  TO: { latitude: -21.18, longitude: -175.2 },
  ...
  TC: { latitude: 21.69, longitude: -71.8 },
  ...
  VI: { latitude: 18.34, longitude: -64.9 },
