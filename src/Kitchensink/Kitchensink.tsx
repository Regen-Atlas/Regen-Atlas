...
import { FeeAmount, Route, type SwapOptions, SwapRouter } from "@uniswap/v3-sdk";
import { getBalance, sendTransaction, simulateContract, writeContract } from "@wagmi/core";
...
export const Kitchensink = (): React.ReactElement => {
  ...
  const handleGetPoolOnCelo = async () => {
    ...
    const pool = await getPool(CELO_CHAR_USDC_POOL_ADDRESS, CELO_USDC_TOKEN, CELO_CHAR_TOKEN);
  ...
  const handleGetPoolOnEthereum = async () => {
    ...
    const pool = await getPool(ETHEREUM_USDC_UNI_POOL_ADDRESS, MAINNET_USDC_TOKEN, MAINNET_UNI_TOKEN);
  ...
  return (
    <>
      ...
      <div className="pt-24 p-4">
        ...
        <p className="mb-4">
          This is a kitchen sink component. It is used to test various features and components of the app.
        </p>

        <h2 className="text-xl font-semibold mb-2">Trade</h2>
        <div>
          <div className="mb-4">
            <button className="button" onClick={handleTokenApprovalOnCelo} disabled={chainId !== 42220}>
          ...
          <div className="mb-4">
            <button className="button" onClick={handleGetQuoteSimulationCelo} disabled={chainId !== 42220}>
          ...
          <div className="mb-4">
            <button className="button" onClick={handleGetPoolOnCelo} disabled={chainId !== 42220}>
              Get Pool Uniswap object on CELO
            </button>
            <button className="button" onClick={handleGetPoolOnEthereum} disabled={chainId !== 1 && chainId !== 31337}>
              Get Pool Uniswap object on Ethereum Mainnet
            </button>
          </div>
          <div className="mb-4">
            <button className="button" onClick={handleGetQuoteFromQuoterOnCelo} disabled={chainId !== 42220}>
          ...
          <div className="mb-4">
            <button className="button" onClick={handleGetUncheckedTradeOnCelo} disabled={chainId !== 42220}>
          ...
          <div className="mb-4">
            <button className="button" onClick={handleGetMethodParametersOnCelo} disabled={chainId !== 42220}>
          ...
          <div className="mb-4">
            <button className="button" onClick={handleSwapOnCelo} disabled={chainId !== 42220}>
              Swap on CELO
            </button>
            <button className="button" onClick={handleSwapOnMainnet} disabled={chainId !== 1 && chainId !== 31337}>
          ...
          <div className="mb-4 flex gap-8">
            <div className="w-[340px]">
              ...
              {chainId === 42220 && <UniswapTrading tokenPair={[CELO_USDC_TOKEN, CELO_CHAR_TOKEN]} />}
            </div>
            <div className="w-[340px]">
              <div>SWAP on Ethereum</div>
              {(chainId === 1 || chainId === 31337) && (
                <UniswapTrading tokenPair={[MAINNET_USDC_TOKEN, MAINNET_UNI_TOKEN]} />
              )}
            </div>
          </div>
          <div className="mb-4 flex gap-8">
            <div className="w-[340px] grid p-4">
              <div className="mb-4">
                <span>
                  USDC balance on CELO: <span className="font-bold">{tokenBalances[CELO_USDC_TOKEN_ADDRESS]}</span>
                </span>
                <button
              ...
              <div>
                <span>
                  CHAR balance on CELO: <span className="font-bold">{tokenBalances[CELO_CHAR_TOKEN_ADDRESS]}</span>
                </span>
                <button
                  disabled={chainId !== 42220}
                  className="button mt-4"
            ...
            <div className="w-[340px] grid p-4">
              <div className="mb-4">
                <span>
                  ...
                  <span className="font-bold">{tokenBalances[MAINNET_USDC_TOKEN_ADDRESS]}</span>
                </span>
                <button
                  disabled={chainId !== 1 && chainId !== 31337}
                  className="button mt-4"
              ...
              <div className="mb-4">
                <span>
                  UNI balance on Ethereum: <span className="font-bold">{tokenBalances[MAINNET_UNI_TOKEN_ADDRESS]}</span>
                </span>
                <button
                  disabled={chainId !== 1 && chainId !== 31337}
                  className="button mt-4"
