  ...
  translations: {
    en: {
      consentModal: {
        ...
        description: "We use cookies to enhance your experience. You can choose which ones to allow below.",
      },
      consentNotice: {
        description: "We use cookies to enhance your browsing experience. Manage your preferences or accept all.",
