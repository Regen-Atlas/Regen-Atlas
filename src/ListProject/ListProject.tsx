...
const ENTITY_OPTIONS: { key: EntityType; label: string; icon: typeof TreeStructure; description: string }[] = [
  {
    ...
    label: "Asset",
    icon: TreeStructure,
    description: "Carbon credits, biodiversity tokens, renewable energy certificates, or other tokenized green assets.",
  },
  {
    key: "actor",
    label: "Actor",
    icon: Users,
    description: "Organizations, DAOs, protocols, or AI agents working in the green economy.",
  },
  {
    key: "action",
    label: "Action",
    icon: Lightning,
    description: "Onchain activities — retirements, conservation actions, or verified impact.",
  },
];

const ASSET_TYPES = ["Commodities", "Impact RWAs", "Clean Energy", "Ecotokens", "Crypto-native", "Currency"];

const ACTION_PROTOCOLS = ["Ecocerts", "Atlantis", "Silvi", "Hedera Guardian"];
...
const inputClass =
  "w-full px-3 py-3 min-h-[44px] border border-gray-200 rounded text-sm focus:outline-none focus:border-gray-400 bg-white";
      ...
      <>
        ...
        <div className="min-h-screen bg-background pt-[60px] lg:pt-[36px]">
          <div className="max-w-[640px] mx-auto px-4 py-20 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">We'll review your project and get back to you shortly.</p>
            <a
              href="/"
    ...
    <>
      ...
      <div className="min-h-screen bg-background pt-[60px] lg:pt-[36px]">
        <div className="max-w-[640px] mx-auto px-4 py-12 lg:py-16 pb-24">
          ...
          <p className="text-xs text-gray-400 mb-8">{ENTITY_OPTIONS.find((o) => o.key === entityType)?.description}</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Amazon Green Wall NFT Series 2"
                  />
                </div>
                <div>
                ...
                <div>
                  <label className={labelClass}>
                    <LinkSimple size={11} className="inline mr-1" />
                    Token / Contract Link
                  </label>
                  <input
                    name="token_link"
                    type="url"
                    className={inputClass}
                    placeholder="Block explorer link to the token or contract"
                  />
                </div>
                <div>
                  <label className={labelClass}>
                  ...
                  <input
                    ...
                    required
                    className={inputClass}
                    placeholder="e.g. Uniswap pool, OpenSea collection, or exchange listing"
                  />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    type="url"
                    className={inputClass}
                    placeholder="URL of a photo or image representing this asset"
                  />
                </div>
                <div>
                  <label className={labelClass}>
            ...
            {entityType === "actor" && (
              <>
                ...
                <div>
                  <label className={labelClass}>
                    {actorSubtype === "organization" ? "Organization" : "Agent"} Name *
                  </label>
                  <input
                    name="name"
                    required
                    className={inputClass}
                    placeholder={actorSubtype === "organization" ? "e.g. Greenpill Brasil" : "e.g. owockibot"}
                  />
                </div>
                <div>
                  <label className={labelClass}>Description *</label>
                  <textarea
                    ...
                    placeholder={
                      actorSubtype === "organization"
                        ...
                        : "What does this agent do? What protocols does it use?"
                    }
                  />
                </div>
                {actorSubtype === "organization" && (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      name="location"
                      required={actorSubtype === "organization"}
                      className={inputClass}
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className={inputClass}
                    placeholder="Block explorer link to treasury, multisig, or agent address"
                  />
                </div>
                <div>
                  <label className={labelClass}>Image URL</label>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 text-[10px] font-semibold text-primary-400 hover:text-primary-500 cursor-pointer"
                    >
                      <Plus size={10} /> Add link
                    </button>
                  </div>
                  {socialLinks.length === 0 && <p className="text-xs text-gray-400">No social links added yet.</p>}
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    required
                    className={inputClass}
                    placeholder="e.g. Mangrove Restoration — Sindhudurg Coast"
                  />
                </div>
                <div>
                  <label className={labelClass}>Description *</label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={inputClass}
                      placeholder="Type or select a protocol"
                    />
                    <datalist id="protocol-options">
                      {ACTION_PROTOCOLS.map((p) => (
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className={inputClass}
                    placeholder="Block explorer, IPFS, or verification link"
                  />
                </div>
                <div>
                  <label className={labelClass}>Image URL</label>
                  <input
                    ...
                    type="url"
                    className={inputClass}
                    placeholder="URL of a photo representing this action"
                  />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
