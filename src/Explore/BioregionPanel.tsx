      ...
      <div className="flex border-b border-gray-200 shrink-0 bg-white">
        {[
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-1 py-3 lg:py-2.5 text-[11px] lg:text-xs font-medium transition-colors min-h-[44px] ${
              activeTab === tab.key
