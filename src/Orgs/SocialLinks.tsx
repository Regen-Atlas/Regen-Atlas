  ...
  return (
    <div className="flex gap-2">
      {org.social.slice(0, 8).map((social) => (
        <a className="block" href={social.link} target="_blank" rel="noopener noreferrer" key={social.platform}>
          <div className="font-bold tooltip cursor-pointer" data-tip={social.platform}>
            {social.platform === "facebook" ? (
              ...
              <img src="/social/karmagap.svg" alt="karmagap" width={32} height={32} />
            ) : social.platform === "farcaster" ? (
              <img src="/social/farcaster.svg" alt="farcaster" width={32} height={32} />
            ) : social.platform === "mirror" ? (
              <img src="/social/mirror.png" alt="mirror" width={32} height={32} />
              ...
              <div className="w-8 h-8 flex justify-center items-center">
                <img src="/social/signal.svg" alt="signal" width={28} height={28} />
              </div>
              ...
              <div className="w-8 h-8 flex justify-center items-center">
                <img src="/social/bluesky.svg" alt="bluesky" width={28} height={28} />
              </div>
            ) : social.platform === "charmverse" ? (
              <img src="/social/charmverse.webp" alt="charmverse" width={32} height={32} />
              ...
              <div className="w-8 h-8 flex justify-center items-center">
                <img src="/social/discourse.svg" alt="discourse" width={28} height={28} />
              </div>
            ) : social.platform === "github" ? (
              <GithubLogo weight="fill" size={32} color="#181717" />
            ) : social.platform === "gitbook" ? (
              <div className="w-8 h-8 flex justify-center items-center">
                <img src="/social/gitbook.png" alt="gitbook" width={28} height={28} />
              </div>
              ...
              <div className="w-8 h-8 flex justify-center items-center">
                <img src="/social/giveth.svg" alt="giveth" width={28} height={28} />
              </div>
            ) : null}
          </div>
        </a>
